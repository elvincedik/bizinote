                    ...
                    <span v-if="props.column.field == 'actions'">
                        <div>
                            ...
                            >
                                ...
                                <b-dropdown-item
                                    title="SMS"
                                    @click="Purchase_SMS(props.row.id)"
                                >
                                    <i
...
export default {
    ...
    methods: {
        ...
        Purchase_PDF() {
            ...
            // Calculate totals
            let totalGrandTotal = self.purchases.reduce(
                (sum, purchase) => sum + parseFloat(purchase.GrandTotal || 0),
                0
            );
            let totalPaidAmount = self.purchases.reduce(
                (sum, purchase) => sum + parseFloat(purchase.paid_amount || 0),
                0
            );
            let totalDue = self.purchases.reduce(
                (sum, purchase) => sum + parseFloat(purchase.due || 0),
                0
            );
