<template>
    <div class="main-content">
        <div>
            <p>HRM / Leave Request</p>
        </div>
        <h3 class="mb-0">Leave Request</h3>
        <h5 class="mt-4">Leave Request</h5>
                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'actions'">
                        ...
                        <a
                            ...
                            class="cursor-pointer"
                            v-b-tooltip.hover
                            @click="Remove_Leave(props.row.id)"
                        >
...
export default {
    ...
    methods: {
            ...
            axios
                ...
                .then((response) => {
                    if (response.data.isvalid == false) {
                        ...
                        this.makeToast(
                            "danger",
                            this.$t("remaining_leaves_are_insufficient"),
                            this.$t("Failed")
                        );
                    } else {
        ...
        Update_Leave() {
            ...
            axios
                .post("/leave/" + self.leave.id, self.data)
                .then((response) => {
                    if (response.data.isvalid == false) {
                        self.SubmitProcessing = false;
                        self.errors = {};
