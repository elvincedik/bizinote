<template>
    <div class="main-content">
        <div>
            <p>HRM / Office Shift</p>
        </div>
        <h3 class="mb-0">Office Shift</h3>
        <h5 class="mt-4">Office Shift</h5>
            ...
            >
                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'actions'">
                        <a
                            @click="Edit_Office_Shift(props.row)"
                        ...
                        <a
                            ...
                            class="cursor-pointer"
                            v-b-tooltip.hover
                            @click="Remove_Office_Shift(props.row.id)"
                        >
                    ...
                    <b-row>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('Monday_In')">
                                <vue-clock-picker
                                    v-model="office_shift.monday_in"
                                    :placeholder="$t('Monday_In')"
                                    name="monday_in"
                                    id="monday_in"
                                ></vue-clock-picker>
                            </b-form-group>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('Monday_Out')">
                                <vue-clock-picker
                                    v-model="office_shift.monday_out"
                                    :placeholder="$t('Monday_Out')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('Tuesday_In')">
                                <vue-clock-picker
                                    v-model="office_shift.tuesday_in"
                                    :placeholder="$t('Tuesday_In')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('tuesday_out')">
                                <vue-clock-picker
                                    v-model="office_shift.tuesday_out"
                                    :placeholder="$t('tuesday_out')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('wednesday_in')">
                                <vue-clock-picker
                                    v-model="office_shift.wednesday_in"
                                    :placeholder="$t('wednesday_in')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('wednesday_out')">
                                <vue-clock-picker
                                    v-model="office_shift.wednesday_out"
                                    :placeholder="$t('wednesday_out')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('thursday_in')">
                                <vue-clock-picker
                                    v-model="office_shift.thursday_in"
                                    :placeholder="$t('thursday_in')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('thursday_out')">
                                <vue-clock-picker
                                    v-model="office_shift.thursday_out"
                                    :placeholder="$t('thursday_out')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('friday_in')">
                                <vue-clock-picker
                                    v-model="office_shift.friday_in"
                                    :placeholder="$t('friday_in')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('friday_out')">
                                <vue-clock-picker
                                    v-model="office_shift.friday_out"
                                    :placeholder="$t('friday_out')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('saturday_in')">
                                <vue-clock-picker
                                    v-model="office_shift.saturday_in"
                                    :placeholder="$t('saturday_in')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('saturday_out')">
                                <vue-clock-picker
                                    v-model="office_shift.saturday_out"
                                    :placeholder="$t('saturday_out')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('sunday_in')">
                                <vue-clock-picker
                                    v-model="office_shift.sunday_in"
                                    :placeholder="$t('sunday_in')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
                        ...
                        <b-col md="3">
                            <b-form-group :label="$t('sunday_out')">
                                <vue-clock-picker
                                    v-model="office_shift.sunday_out"
                                    :placeholder="$t('sunday_out')"
                                ></vue-clock-picker>
                            </b-form-group>
                        </b-col>
