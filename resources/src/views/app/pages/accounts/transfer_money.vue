<template>
    <div class="main-content">
        <div class="bg-white mb-3 py-1 px-3">
            <p>Accounting / Transfer money</p>
            <h3 class="mb-0">Transfer money</h3>
        </div>
        <div
            class="bg-white py-1 px-3 rounded-top"
            style="box-shadow: 0 .5rem 1rem rgba(0, 0, 0, 0.15) !important;"
        >
            <h5 class="mt-4">Transfer money</h5>
            ...
            >
                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'actions'">
                        <a
                            @click="Edit_transfer_money(props.row)"
                            title="Edit"
                            v-b-tooltip.hover
                        >
                            <i
                        ...
                        <a
                            title="Delete"
                            v-b-tooltip.hover
                            @click="Remove_transfers_money(props.row.id)"
                        >
                            <i
    ...
    methods: {
        ...
        Create_transfer_money() {
            if (this.transfer.from_account_id === this.transfer.to_account_id) {
                this.makeToast(
                    "danger",
                    this.$t("Accounts_cannot_be_the_same"),
                    this.$t("Failed")
                );
                return;
            }
