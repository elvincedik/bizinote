                        ...
                        <div>
                            ...
                            >
                                ...
                                <b-dropdown-item
                                    ...
                                    "
                                    :to="
                                        '/app/sales/sale_return/' + props.row.id
                                    "
                                >
                                    <i
                                ...
                                <b-dropdown-item
                                    ...
                                    @click="Send_WhatsApp(props.row.id)"
                                >
                                    <i
                        ...
                        <b-col lg="4" md="12" sm="12">
                            ...
                            >
                                <b-form-group :label="$t('Paying_Amount')">
                                    <b-form-input
                                        @keyup="
                                            Verified_paidAmount(payment.montant)
                                        "
                                        label="Amount"
                        ...
                        <b-col lg="12" md="12" sm="12">
                            ...
                            >
                                <div
                                    v-once
                                    class="typo__p"
                                    v-if="submit_showing_credit_card"
                                >
                                    <div
                                ...
                                >
                                    <div class="mt-3">
                                        <span class="mr-3"
                                            >Saved Credit Card Info For This
                                            Client
                                        </span>
                                        <b-button
                    ...
                    <b-row>
                        ...
                        <b-col md="12" class="mt-3">
                            ...
                            <div
                                v-once
                                class="typo__p"
                                v-if="Submit_Processing_shipment"
                            >
                                <div
                                    class="spinner sm spinner-primary mt-3"
                                ></div>
                    ...
                    <div class="info">
                        ...
                        <p>
                            ...
                            <span v-show="pos_settings.show_address"
                                >{{ $t("Adress") }} :
                                {{ invoice_pos.setting.CompanyAdress }} <br
                            /></span>
                            <span v-show="pos_settings.show_email"
                                >{{ $t("Email") }} :
                                {{ invoice_pos.setting.email }} <br
                            /></span>
                            ...
                            <span v-show="pos_settings.show_Warehouse"
                                >{{ $t("warehouse") }} :
                                {{ invoice_pos.sale.warehouse_name }} <br
                            /></span>
                        </p>
                    </div>
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr
                                ...
                                v-show="pos_settings.show_discount"
                            >
                        ...
                        <tbody>
                            <tr v-for="payment_pos in payments">
                                <td style="text-align: left" colspan="1">
                                    {{
                                        payment_pos.payment_method
                                            ? payment_pos.payment_method.name
                                            : "---"
                                    }}
                                </td>
...
export default {
    ...
    methods: {
        ...
        Sales_PDF() {
            ...
            let totalGrandTotal = self.sales.reduce(
                (sum, sale) => sum + parseFloat(sale.GrandTotal || 0),
                0
            );
            let totalPaidAmount = self.sales.reduce(
                (sum, sale) => sum + parseFloat(sale.paid_amount || 0),
                0
            );
            let totalDue = self.sales.reduce(
                (sum, sale) => sum + parseFloat(sale.due || 0),
                0
            );
        ...
        Create_Payment() {
            ...
            NProgress.set(0.1);
            if (
                (this.payment.payment_method_id == "1" ||
                    this.payment.payment_method_id == 1) &&
                this.is_new_credit_card
            ) {
                if (this.stripe_key != "") {
