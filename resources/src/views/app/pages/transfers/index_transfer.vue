<template>
    <div class="main-content">
        <div>
            <p>HRM / All transfers</p>
        </div>
        <h3 class="mb-0">All transfers</h3>
        <h5 class="mt-4">All transfers</h5>
                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'actions'">
                        <a
                            ...
                            v-b-tooltip.hover
                            @click="
                                download_transfer_pdf(props.row, props.row.id)
                            "
                        >
                            <i
                                class="i-File-TXT text-25 text-primary cursor-pointer"
                            ></i>
                        </a>
                        ...
                        >
                            <i
                                class="i-Eye text-25 text-info cursor-pointer"
                            ></i>
                        </a>
                        <router-link
                            v-if="
                                currentUserPermissions &&
                                currentUserPermissions.includes('transfer_edit')
                            "
                            title="Edit"
                            v-b-tooltip.hover
                            :to="{
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    }}{{ formatNumber(transfer.GrandTotal, 2) }}
                                </th>
                            </tr>
                            <!-- Status -->
                            <tr>
...
export default {
    ...
    methods: {
        ...
        Transfer_PDF() {
            ...
            // Calculate totals
            let totalGrandTotal = self.transfers.reduce(
                (sum, transfer) => sum + parseFloat(transfer.GrandTotal || 0),
                0
            );
