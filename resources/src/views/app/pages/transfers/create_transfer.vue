<template>
    <div class="main-content">
        <div>
            <p>purchases / Create Transfer</p>
        </div>
        <h3 class="mb-5">Create Transfer</h3>
        <!-- <breadcumb
            :page="$t('Create_Transfer')"
            :folder="$t('ListTransfers')"
        /> -->
        <div
            v-if="isLoading"
    ...
    methods: {
        ...
        search() {
            ...
            if (
                ...
                this.transfer.from_warehouse != null
            ) {
        ...
        Calcul_Total() {
            ...
            for (let index = 0; index < this.details.length; index++) {
                var tax =
                    this.details[index].taxe * this.details[index].quantity;
                this.details[index].subtotal = parseFloat(
                    this.details[index].quantity *
                        this.details[index].Net_cost +
                        tax
                );
                this.total = parseFloat(
                    this.total + this.details[index].subtotal
                );
            }
            ...
            this.GrandTotal = parseFloat(
                total_without_discount +
                    this.transfer.TaxNet +
                    this.transfer.shipping
            );
        ...
        Get_Product_Details(product_id, variant_id) {
            axios
                ...
                .then((response) => {
                    ...
                    this.product.purchase_unit_id =
                        response.data.purchase_unit_id;
                    this.add_Detail();
                    this.Calcul_Total();
                });
        },
