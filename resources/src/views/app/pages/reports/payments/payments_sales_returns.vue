<template>
    <div class="main-content">
        <div class="bg-white mb-3 py-1 px-3">
            <p>Report / Payment Sales Return</p>
            <h3 class="mb-0">Payment Sales Return</h3>
        </div>
        <!-- <breadcumb
            :page="$t('payments_Sales_Return')"
            :folder="$t('Reports')"
        /> -->
        ...
        <router-link tag="a" class to="/app/reports/payments_sale">
            <span class="btn text-dark">{{ $t("Sales") }}</span>
        </router-link>
        <router-link tag="a" class to="/app/reports/payments_sales_returns">
            <span
                class="btn text-dark"
                style="border-bottom: 2px solid #4d00ff !important"
                >{{ $t("SalesReturn") }}</span
            >
        </router-link>
        <router-link tag="a" class to="/app/reports/payments_purchases_returns">
            <span class="btn text-dark">{{ $t("PurchasesReturn") }}</span>
        </router-link>
        ...
        >
            ...
            <h5 class="mt-4">Payment Sales Return</h5>
            <hr
                class="mt-1"
