<template>
    <div class="main-content">
        ...
        <router-link tag="a" class to="/app/reports/payments_sales_returns">
            <span class="btn text-dark">{{ $t("SalesReturn") }}</span>
        </router-link>
        <router-link tag="a" class to="/app/reports/payments_purchases_returns">
            <span class="btn text-dark" style="border-bottom: 2px solid #4d00ff !important">{{ $t("PurchasesReturn") }}</span>
        </router-link>
        ...
        <div
            class="bg-white py-3 px-3 rounded-top mt-3"
            style="box-shadow: 0 0.5rem 1rem rgba(0, 0, 0, 0.15) !important"
        >
            <b-col md="12" class="" v-if="!isLoading">
                <date-range-picker
                    v-model="dateRange"
                    :startDate="startDate"
                    :endDate="endDate"
            ...
            <h5 class="mt-4">Purchase Returns</h5>
            <hr
                class="mt-1"
            ...
            <div class="px-3 py-2">
                <b-row>
                    ...
                    <b-col md="6" sm="12">
                        <b-button
                            @click="
                                Payments_Purchase_returns(serverParams.page)
                            "
...
export default {
    ...
    methods: {
        ...
        Payment_PDF() {
            ...
            // Calculate totals
            let totalGrandTotal = self.payments.reduce(
