            ...
            >
                <b-row>
                    <b-col md="10" class="mb-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <i
                                                                class="i-Bar-Code cursor-pointer"
                                                            ></i>
                                                        </a>
                                                    </span>
                                                </div>
                                    ...
                                    >
                                        <b-form-group :label="$t('OrderTax')">
                                            <div class="input-group">
                                                ...
                                                >
                                                    <span
                                                        class="input-group-text rounded-3"
                                                        style="
                                                            border: 1px solid
                                                                #e9eaeb !important;
                                                        "
                        ...
                        <!-- <b-card
                            class="mt-3"
                            :header="$t('Warranty_Guarantee_Tracking')"
                        > -->
                        <b-card class="mt-3">
                            <div
                        ...
                        > -->
                        <b-card class="mt-3" v-if="product.type == 'is_single'">
                            <div
                                class="bg-white py-1 px-3 rounded-top"
                                style="width: 150px"
                            >
                                <h5 class="mt-4">Opening stock</h5>
                                <hr
                                    class="mt-1"
                                    style="
                                        border-left: 14px solid #0944aa;
                                ...
                                <b-col md="12 mb-2">
                                    ...
                                    >
                                        <div class="form-check">
                                            <label
                                                class="checkbox checkbox-outline-nprimary"
                                            >
                                                <input
                                                    type="checkbox"
    ...
    methods: {
        ...
        search() {
            ...
            this.timer = setTimeout(() => {
                const product_filter = this.products_ing.filter(
                    (ingredient) => ingredient.code === this.search_input
                );
                if (product_filter.length === 1) {
                    this.SearchProduct(product_filter[0]);
                } else {
                    this.product_filter = this.products_ing.filter(
                        (ingredient) => {
                            return (
                                ingredient.name
                                    .toLowerCase()
        ...
        Create_Product() {
            ...
            if (
                Object.keys(self.product.warehouses).length &&
                self.product.type == "is_single"
            ) {
                self.data.append(
                    "warehouses",
