                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'actions'">
                        ...
                        <a
                            title="Delete"
                            v-b-tooltip.hover
                            @click="Remove_Unit(props.row.id)"
                        >
                            <i class="i-Close-Window text-25 text-danger"></i>
                        </a>
                    </span>
                    <div v-else-if="props.column.field == 'BaseUnit'">
                        <span v-if="props.row.base_unit_name != ''">{{
                ...
                <b-form @submit.prevent="Submit_Unit">
                    <b-row>
                        ...
                        <b-col md="12" v-show="show_operator">
                            ...
                            >
                                <b-form-group
                                    :label="$t('OperationValue') + ' ' + '*'"
                                >
                                    <b-form-input
                                        :placeholder="
                                            $t('Enter_Operation_Value')
                                        "
                                        :state="
                                            getValidationState(
                                                validationContext
                        ...
                        .then((response) => {
                            if (response.data.success) {
                                ...
                                this.$swal(
                                    ...
                                    this.$t(
                                        "Unit_already_linked_with_sub_unit"
                                    ),
                                    "warning"
                                );
                            }
