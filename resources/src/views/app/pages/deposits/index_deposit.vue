                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'actions'">
                        <router-link
                            v-if="
                                currentUserPermissions &&
                                currentUserPermissions.includes('deposit_edit')
                            "
                            title="Edit"
                            v-b-tooltip.hover
...
export default {
    ...
    methods: {
        ...
        Deposit_PDF() {
            ...
            // Calculate totals
            let totalGrandTotal = self.deposits.reduce(
